  ...
  return (
    ...
    >
      <div className="bg-card border border-card-border rounded-2xl p-8 max-w-md w-full text-center space-y-4">
        ...
        <h2 className="text-lg font-semibold text-heading">Failed to load project</h2>
        <p className="text-sm text-muted">{error.message || 'An unexpected error occurred while loading this project.'}</p>
